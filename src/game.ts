...
import { PakistaniDeveloper, HomelessMan, Sebastian, Zaid, ElonMusk, Muhammad, SuperMuhammad, UltraMuhammad, OmegaMuhammad, ClickParticle } from "./entities";
...
export class Game {
  ...
  private entities: (PakistaniDeveloper | HomelessMan | Sebastian | Zaid | ElonMusk | Muhammad | SuperMuhammad | UltraMuhammad | OmegaMuhammad)[] = [];
  ...
  private async applyOfflineIncome() {
    const offlineIncome = calculateOffineIncome(this.state);
  ...
  // Buying methods updated to include new ones
  ...
  // Spawn methods for new entities
