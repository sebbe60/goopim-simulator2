...
export abstract class Entity {
  ...
  abstract animate(ctx: CanvasRenderingContext2D, tick: number): void;
}

export class PakistaniDeveloper extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = false; // Basic entities are static to optimize performance
  }
...
export class HomelessMan extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = false;
  }
...
export class Sebastian extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = false;
  }
...
export class Zaid extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = false;
  }
...
export class ElonMusk extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = false;
  }
...
export class Muhammad extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = true; // Premium entities animate for visual appeal
  }
...
export class SuperMuhammad extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = true;
  }
  ...
  animate(ctx: CanvasRenderingContext2D, tick: number) {
    const scale = 1 + Math.sin(tick * 0.2) * 0.2;
    ctx.save();
...
export class UltraMuhammad extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = true;
  }
...
export class OmegaMuhammad extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = true;
  }
...
export class AscendedMuhammad extends Entity {
  constructor(public x: number, public y: number) {
    super();
    this.animated = true;
  }
